...
COPY --chown=family:family app.py integrations.py meals.py migrations.py nanny.py recipe_images.py meal_suggestions.py shopping_week.py meal_reminders.py closures.py lina.py vouchers.py speech.py minijob.py offline.py work_calendar.py backups.py manage.py docker-entrypoint.py ./
