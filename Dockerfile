...
COPY --chown=family:family app.py integrations.py meals.py migrations.py nanny.py recipe_images.py meal_suggestions.py shopping_week.py manage.py docker-entrypoint.py ./
