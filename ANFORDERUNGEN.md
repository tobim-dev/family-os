...
| B-17 | Wunsch 26.09.2026: Aus einer Aufgabe zum Arbeitskalender per Deep-Link direkt einen vorausgefüllten Termin in der Outlook-App auf dem eigenen iPhone erzeugen. | Vorhanden, Test auf den iPhones offen: „In Outlook eintragen“ (ms-outlook://, Ortszeit) und „In Outlook im Web“ (outlook.office.com, UTC) an Aufgaben, die einen neuen Block verlangen; übergeben werden nur Titel „Lina bringen/abholen“ und Zeit. „Abwesend“ muss in Outlook selbst gesetzt werden, Entfernen alter Blöcke bleibt manuell. Family OS liest den Arbeitskalender nie (B-02); nicht funktionierende Variante wird nach dem Test entfernt. |
