...
| --- | --- | --- |
| Z-01 | Eine zentrale Anlaufstelle für die Familienplanung schaffen, damit weniger vergessen wird und Informationen ohne Suchen in Nachrichten auffindbar sind. | Vorhanden in erster Ausbaustufe: Betreuung, Aufgaben, Essen, Nanny, Lina, Gutscheine, Spracheingabe und Offline-Lesekopie. Viele Regeln noch vorläufig (Abschnitt 9). |
...
| B-13 | Nach einer bestätigten Änderung eine explizite Aufgabe „Arbeitskalender aktualisieren“ erzeugen. | Vorhanden: betroffene Person pflegt den eigenen Kalender; die ausstehenden Einträge stehen gebündelt in einer Aufgabe je Person (B-18). |
...
| B-17 | Wunsch 26.09.2026: Aus einer Aufgabe zum Arbeitskalender per Deep-Link direkt einen vorausgefüllten Termin in der Outlook-App auf dem eigenen iPhone erzeugen. | Vorhanden: „In Outlook eintragen“ (ms-outlook://) funktioniert laut Tobi (26.09.2026) in der Outlook-App; die App liest Zeiten ohne Zone als UTC, daher wird UTC übergeben (Fehler „eine Stunde später“ behoben). „Im Web“ bleibt als Ausweg. Übergeben werden nur Titel „Lina bringen/abholen“ und Zeit. „Abwesend“ muss in Outlook selbst gesetzt werden, Entfernen bleibt manuell. Family OS liest den Arbeitskalender nie (B-02). |
| B-18 | Wunsch 26.09.2026: Aufgaben zum Arbeitskalender bündeln – eine Aufgabe je Person, die alle einzutragenden bzw. zu entfernenden Termine nennt; abgearbeitet wird alles auf einmal. | Vorhanden: höchstens eine offene Aufgabe „Arbeitskalender aktualisieren“ je Person mit Liste „Eintragen“/„Entfernen“ (je Eintrag Outlook-Knöpfe, B-17). Vorläufige Regeln: nie eingetragene Blöcke heben sich mit ihrer Entfernung auf; neuere Zeit ersetzt einen offenen Eintrag; Abhaken erledigt nur die angezeigten Einträge. Bestehende Einzelaufgaben werden bei Migration 6 übernommen. |
...
| N-06 | Nanny ist auf Minijob-Basis beschäftigt; vereinbarter Lohn 20 EUR pro Stunde. | Vorhanden: Stundenlohn einstellbar (Vorgabe 20 EUR), wird beim Monatsabschluss eingefroren. Abgaben siehe N-12. |
| N-07 | Monatlich Stunden und daraus folgenden Lohnbetrag nachvollziehbar zusammenstellen. Tobi überweist den Betrag. | Vorhanden: Monatsübersicht je Termin, Überweisungsbetrag an die Nanny und Abgaben an die Minijob-Zentrale (N-12), Abschluss nach Monatsende, Markierung „überwiesen“. Keine automatische Überweisung. |
...
| N-12 | Wunsch 26.09.2026: Anzeigen, wie viel am Monatsende an die Nanny zu überweisen ist und wie viel die Minijob-Zentrale einzieht, mit allen Steuern und Abgaben. Entscheidung Tobi: Minijob im Privathaushalt (Haushaltsscheck), Nanny von der Rentenversicherung befreit, Pauschsteuer tragen die Eltern. | Vorhanden: Überweisung = voller Lohn; Abgaben 14,62 % (KV 5, RV 5, Pauschsteuer 2, U1 0,8, U2 0,22, UV 1,6; Stand 2026, in der App einstellbar) je Monat und für das Halbjahr mit Einzugsmonat (Juli bzw. Januar). Rundung je Bestandteil auf volle Cent; maßgeblich bleibt der Bescheid der Minijob-Zentrale. Warnung über der Minijob-Grenze (603 EUR). Beim Abschluss festgehalten. Sätze aus öffentlichen Quellen, Abgleich mit dem Haushaltsscheck-Rechner empfohlen. |
| N-13 | Wunsch 26.09.2026: Nanny-Termine, die schon stattgefunden haben (z. B. September), für die Abrechnung nachtragen. | Vorhanden: „Nachtragen“ in der Nanny-Ansicht: mehrere Tage eines Monats (auch Wochenende) bis einschließlich heute, gemeinsame Zeit und Notiz, direkt als bestätigt gespeichert, ohne WhatsApp-Anfrage. Nicht in abgeschlossenen Monaten, keine Überschneidung; die andere Person wird informiert. Abweichende Zeiten danach über „Tatsächliche Zeit“. |
...
| E-17 | Entscheidung 26.09.2026 (O-10): Offline reicht lesend; die Einkaufsliste wird auf dem iPhone zwischengespeichert. Abgehakt wird weiterhin in der Cookidoo-App, die selbst offline arbeitet. | Vorhanden: Service Worker speichert beim Öffnen mit Verbindung (höchstens alle 5 Minuten) die letzte Einkaufsliste und die aktiven Gutschein-PDFs; ohne Verbindung, bei Zeitüberschreitung oder wenn das NAS nicht antwortet erscheint „Einkauf offline“ mit Zeitstempel. Keine Änderungen offline, kein Rückabgleich. Abmelden löscht die Kopie. |
| E-18 | Wunsch 26.09.2026: Angeben können, dass für die Woche bereits eingekauft wurde, damit nicht mehr angezeigt wird, dass Rezepte noch auf die Einkaufsliste müssen (z. B. wenn die Liste nach dem Einkauf schon gelöscht ist). | Vorhanden: „Schon eingekauft“ je Woche (mit Person und Zeit, zurücknehmbar); danach kein Wochenwechsel, kein „Zutaten hinzufügen“ und keine Freitags-Aufgabe „Einkaufsliste vorbereiten“. Cookidoo wird dabei nicht verändert. |
| E-19 | Wunsch 26.09.2026: Bei der Planung mit Claude einzelne Gerichte neu vorschlagen lassen. | Vorhanden: „Anderes Gericht“ je Tag ersetzt nur diesen Tag; abgelehnte Gerichte kommen in der Woche nicht wieder, keine Doppelung mit anderen Tagen. Zuerst aus den bereits geprüften Kandidaten der Woche, sonst neue Cookidoo-Suche. War der Wochenvorschlag mit Claude, fragt es Claude für diesen einen Tag; zusätzlich gesendet werden nur die Namen der übrigen Gerichte der Woche. Zählt zum Monatslimit, lokaler Ersatz bei Fehlern. |
...
| E-13 | Einkaufsinformationen sollen unterwegs schnell zugänglich sein. | Vorhanden: Einkaufsliste und aktive Gutschein-PDFs werden auf dem iPhone automatisch zwischengespeichert und sind ohne Verbindung lesbar (E-17). Praktische Abnahme auf den iPhones offen. |
...
| A-10 | Entscheidung 26.09.2026 (O-09): Spracherkennung lokal auf dem NAS, zuverlässig auf Deutsch; nur falls lokal nicht tragfähig ein sehr datenarmer Dienst. | Vorhanden: Whisper „large-v3-turbo“ über faster-whisper auf der CPU, Sprache fest Deutsch, Stille-Filter und Verwerfen typischer Phantomsätze; Text erscheint immer zuerst zur Kontrolle im Feld. Einmaliger Modell-Download (~1,6 GB). Auf dem NAS bestätigt (26.09.2026): läuft, 7,7 s Sprache in 4,1 s umgewandelt. Erkennungsqualität im Alltag weiter beobachten. |
| A-11 | Wunsch 26.09.2026: Ein Tutorial, das Britta durch die App führt und einen Funktionsüberblick gibt. | Vorhanden: geführter Rundgang in 13 Schritten durch die echten Ansichten mit Erklärkarte und Hervorhebung des passenden Knopfs; beim ersten Anmelden einmal je Person angeboten (Merker auf dem NAS), jederzeit über „?“ oben rechts neu startbar. |
| A-12 | Wunsch 26.09.2026: Widget auf dem iPhone-Home-Bildschirm. iOS-Web-Apps können keine Widgets anbieten; Tobi nutzt die App Scriptable. | Vorhanden: persönlicher, nur lesender Widget-Schlüssel je Person (nur als Hash gespeichert, einmal angezeigt, jederzeit widerrufbar oder ersetzbar) unter „Verbindungen“; fertiges Scriptable-Skript zum Kopieren. Widget klein/mittel/groß: heute und morgen Bringen, Abholen, Tage ohne Krippe, bestätigte Nanny-Zeiten, Abendessen (letzter Cookidoo-Abruf), eigene offene Aufgaben und Abstimmungen. Ohne Netz letzter Stand, deutlich als „Offline“ markiert. Aktualisierung bestimmt iOS (etwa alle 15–30 Minuten). |
...
| D-02 | Ausgewählte Inhalte dürfen an einen KI-Dienst übermittelt werden. Adressen und Geburtstage sollen auf dem NAS bleiben. | Rahmen / vorhanden: Anbieter Claude API (Entscheidung 26.09.2026). Datenfilter für Essensvorschläge: nur Wochentag + Zeitgrenze und je Kandidat anonyme Nummer, Rezeptname, Minuten, Eiweiß, Zutatennamen; beim Neuvorschlag eines Tages zusätzlich die Namen der übrigen Gerichte (E-19). Gesendeter Inhalt in der App einsehbar. |
...
| V-01 | Google-Kalender und Einkaufsliste wurden als besonders kritische Bereiche genannt; der Rest ist zunächst weniger kritisch. | Geklärt für den Einkauf (E-17): offline nur lesend. Kalender offline weiterhin über Google selbst; Verfügbarkeitsdauer des NAS nicht festgelegt. |
...
| Offline | Automatische Lesekopie von Einkaufsliste und aktiven Gutscheinen im Browser-Speicher des Geräts (E-17); zusätzlich weiterhin als HTML-Datei speicherbar. Kein Schreiben offline, kein Rückabgleich. |
...
| O-04 | Weitgehend geklärt 26.09.2026 → N-09, N-10, N-12 (Minijob-Abgaben). Offen: Korrektur nach Überweisung. Nanny im Google-Kalender als vorläufige Implementierungsentscheidung umgesetzt (Abschnitt 9). | N-04–N-07 |
...
| O-09 | Geklärt 26.09.2026 → A-10 (lokal). Auf dem NAS gemessen: 7,7 s Sprache in 4,1 s. Wechsel zu einem datenarmen Dienst nur, falls die Qualität im Alltag nicht reicht. | A-01–A-02, D-02 |
| O-10 | Geklärt 26.09.2026 → E-17 (offline nur lesend, Abhaken in Cookidoo). | V-01, E-13 |
