...
- `widget.py` + `static/widget.js`, `static/scriptable/family-os-widget.js`: Home-Bildschirm-Widget über Scriptable (A-12); nur lesender, widerrufbarer Schlüssel je Person, nur `GET /api/widget`.
